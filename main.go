...
func main() {
	...
	if cfg.WAF.Enabled {
		...
		wafMonitor.SetOffsetStore(watcher.NewOffsetStore("./data/waf_offset.json"))
	...
	if cfg.FailGuard.Enabled {
		...
		failguardMonitor.SetOffsetStore(watcher.NewOffsetStore("./data/failguard_offset.json"))
